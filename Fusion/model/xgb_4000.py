...
def model_xgb4000(train, validate, test, return_model=False):
    """
    修改后的XGBoost模型函数
    ...
    model = xgb.train(params, dtrain, num_boost_round=3115, evals=watchlist)
...
def predict_with_model4(model, test_data):
    """
    使用已训练的模型进行预测
    """
